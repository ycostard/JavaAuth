...
public class UserService {
    ...
    public List<User> getAllUsersLocked() {
        return userRepository.findAllByIsNonLocked(false);
    }
    ...
    public void updateLockedUser(User user, boolean isLocked) {
        user.setNonLocked(isLocked);
